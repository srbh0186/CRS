...
import { B as Block, S as Static, g as BlockLabel, z as File$1, i as Empty, U as UploadText, j as IconButtonWrapper, k as IconButton, K as Undo, n as Download } from './2-BNUpI8q7.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-D4-Q9pOE.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-_cDWJPC4.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-C3XHhDOO.js');
  return module.default;
}
...
//# sourceMappingURL=Index56-FUoydROt.js.map
