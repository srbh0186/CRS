...
import { B as Block, S as Static, g as BlockLabel, V as Code$2, i as Empty, k as IconButton, A as Copy$1, D as DownloadLink, n as Download$1, j as IconButtonWrapper, W as getWorkerProxyContext } from './2-BNUpI8q7.js';
...
const lang_map = {
  python: () => import('./index32-mMh_2FEg.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index33-DJKWjzCq.js'),
      import('./frontmatter-DIuQvs6J.js')
    ]);
  ...
  json: () => import('./index37-DsJC1UFZ.js').then((m) => m.json()),
  html: () => import('./index34-Ddnw7zkF.js').then((m) => m.html()),
  css: () => import('./index35-HW0iGpPN.js').then((m) => m.css()),
  javascript: () => import('./index36-C71bELXZ.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index36-C71bELXZ.js').then(
...
//# sourceMappingURL=Index15-CzQGcX9f.js.map
